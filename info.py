...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6942557751 8288097205').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002148375787 -1002133505201').split()]  # Channel id for auto indexing (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Sjdjhdbdbd:Sjdjhdbdbd@cluster0836483846.qj2ol2r.mongodb.net/?appName=Cluster0836483846")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://sujay53721_db_user:sujay53721_db_user@cluster07373646563737.h6q6n5f.mongodb.net/?appName=Cluster07373646563737")
...
LANGUAGES = ["malayalam", "", "tamil", "", "english", "", "hindi", "", "bengali", "", "telugu", "", "kannada", "", "gujarati", "", "marathi", "", "punjabi", ""]
...
if HAS_SSL:
    URL = "https://joint-leelah-afexlegend-944eb40b.koyeb.app/".format(FQDN)
else:
    URL = "https://joint-leelah-afexlegend-944eb40b.koyeb.app/".format(FQDN)
